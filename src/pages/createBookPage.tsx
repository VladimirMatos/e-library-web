...
const CreateBookPage = (): JSX.Element => {
  ...
  const handleChange = (
    value: string | number,
    inputName: "title" | "description" | "category"
  ) => {
  ...
  const handleInputsError = () => {
    ...
    if (input.category === 0) {
      inputEmpty = { ...inputEmpty, category: "Category should not be empty" };
    }
        ...
        <div className="bg-gray-700 w-full">
          ...
          <div className="flex flex-col">
            ...
            <Select
              ...
              onChange={({ target }) =>
                handleCategorySelect(target.value, "category")
              }
              displayEmpty
            ...
            {inputError.category && (
              <span className="text-red-700 m-8">{inputError.category}</span>
            )}
          </div>
        </div>
      </div>
